  ...
  <div :class="$style.container">
    <div style="width: 100%; height: 100%; overflow-y: auto">
      ...
      >
        ...
        ></div>
        <div
          style="width: calc(100% - 33px); height: 100%; min-height: fit-content; flex-shrink: 1; position: relative"
        >
          ...
          <div :class="$style.dummy">
            <div v-for="(line, i) in decorated(textAll, underline)" :key="i" :class="$style.dummyLine">
              <div :class="$style.lineNumber">
                <p :class="$style.lineNumberText" :style="`color: var(--color-${color || 'theme'})`">
                  {{ i + 1 }}
                </p>
              </div>
